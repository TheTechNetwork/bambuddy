          ...
          <ResponsiveContainer width="100%" height={250}>
            <AreaChart data={chartData}>
              ...
              <Tooltip
                ...
                formatter={(value: ValueType | undefined) => [value != null && typeof value === 'number' ? `${value.toFixed(0)}g` : '—', 'Filament']}
              />
              <Area
                type="monotone"
                dataKey="filament"
              ...
              <ResponsiveContainer width={160} height={160}>
                <PieChart>
                  ...
                  <Tooltip
                    ...
                    formatter={(value: ValueType | undefined) => [value != null && typeof value === 'number' ? `${value}g` : '—', 'Usage']}
                  />
                </PieChart>
              </ResponsiveContainer>
